...
App({
  onLaunch: function (o) {
    ...
    this.data.groupNo = wx.getStorageSync('groupNo') || 1;

    console.log(o)
    this.data.query=o.query;
    var that = this;
    var userId = this.data.userId;
    this.requery({ fun: "wx_selectData", tableName: "med_Patient", where: "userId='" + userId + "'" }, function (res) {
